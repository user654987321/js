...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var p0ne_, p0ne, ref$;
console.info("~~~~~~~~~~~~ plug_p0ne edit By Nils G. loading ~~~~~~~~~~~~");
	if (typeof console.time == 'function') {
	  console.time("[p0ne] completely loaded");
	}
	p0ne_ = window.p0ne;
	...
	module.exports = new Promise(function(resolve, reject){
	  ...
	  return new Promise(function(resolve, reject){
	    var noCollapsedGroup, name, ref$, m;
	  ...
	  commands: {
	    ...
	    move: {
	      ...
	      callback: function(args){
	        ...
	        if (1 <= pos && pos <= 50) {
	          if (ids = getMentions(args, {
	            ids: true,
	            expandGenerics: true,
	            unique: true
	          })) {
	            if (!(id = ids[0]) || !getUser(id)) {
	              chatWarn({
	                title: "/move",
...
/***/ function(module, exports) {
	...
	ref$ = out$;
ref$.version = '4.3.0 edit by Nils G.';
...
loadStyle("https://cdn.rawgit.com/NilssMiner99/ZombieApocalipse/master/style.css");
...
$el = $create("<div class=wt-cover></div><div class='container wt-p0' id=walkthrough><div class='step fade-in wt-p0-welcome' data-screen=welcome><h2>Welcome</h2><div class=wt-p0-title><div class=wt-p0-title-p>p</div><div class=wt-p0-title-lug_p>lug_p</div><div class='wt-p0-0 wt-p0-title-0'>0</div><div class=wt-p0-title-ne>ne</div></div> Edit by Nils G.<button class='wt-p0-next continue'>&nbsp;</button></div><div class='step fade-in wt-p0-settings' data-screen=settings><h1>Settings</h1><p>To open/close the plug_p0ne settings, click the <div class=p0ne-icon></div> icon in the top left</p><p class=wt-p0-settings-closed>click the icon now!</p><p class=wt-p0-settings-open>Good job! Let's move on.</p><button class='wt-p0-back'>Zurück</button><button class=wt-p0-next>Überspringen</button></div><div class='step fade-in wt-p0-dblclick2mention' data-screen=dblclick2mention><h1>dblclick2mention</h1><p>One of most often used p0 features is the so called \"DblClick username to Mention\".<br>Just <b>double click</b> their name to <em>@mention</em> them. This is great to quickly greet friends, for example.<br><small>(it works on username in chat, join notifications and just about EVERYWHERE)</small></p><img src=' https://i.imgur.com/jmgTvUF.gif' alt='screenrecording of dblclick2mention' width=350 height=185 /><button class='wt-p0-back'>Zurück</button><button class='wt-p0-next continue'>Weiter</button></div><div class='step fade-in wt-p0-stream-settings' data-screen=stream-settings><h1>Stream Settings</h1><p>plug_p0ne adds a new audio-only mode to videos and let's you quickly switch between<br><i class='icon icon-stream-video'></i> Video<br><i class='icon icon-stream-audio'></i> Audio-Only<br><i class='icon icon-stream-off'></i> Stream-Off (no video/sound)</p><p>You can click the icons to change between the modes.</p><button class='wt-p0-back'>Zurück</button><button class='wt-p0-next continue'>Weiter</button></div><div class='step fade-in wt-p0-automute' data-screen=automute><h1>Automute</h1><p>You can also <b>automute</b> songs you really dislike. This way, they will automatically get muted whenever they are played.</p><p>To add a song to automute, do the following:<ol class=wt-p0-steps><li>Click on <b class=snooze-btn><i class='icon icon-stream-off'></i> Snooze</b> to snooze the current song (stop the video/song)</li><li>When snoozed, the snooze button will turn into an automute -add or -remove button</li></ol></p><p>Let's try it out!<br>(don't worry, we can undo it right away)</p><button class='wt-p0-back'>Zurück</button><button class=wt-p0-next>Überspringen</button></div><div class='step fade-in wt-p0-automute2' data-screen=automute2><h1>Automute</h1><p>Removing songs from the automute list is also easy:<ol class=wt-p0-steps><li>open the settings panel. (<div class=p0ne-icon></div>)</li><li>open the group \"" + automute.settings + "\"</li><li>click on the <i class='icon icon-settings-white'></i>icon next to \"automute\"</li><li>move your mouse over any song in the list and click the <i class='icon icon-clear-input'></i> icon on the song you want to remove from the list</li></ol></p><button class='wt-p0-back'>Zurück</button><button class=wt-p0-next>Überspringen</button></div><div class='step fade-in wt-p0-songinfo' data-screen=songinfo><h1>Song-Info</h1><p>Want to find out more about the current song?</p><p class=wt-p0-songinfo-closed>Click the song title above!</p><div class=wt-p0-songinfo-open>In the top middle you can see two rows.<img src='//i.imgur.com/clwk2QL.png' alt='top row shows author - title as seen on plug.dj, second row shows channel name and upload title as seen on Youtube/Soundcloud' width=338 height=66 /><ul><li>Click on the author or title to search for them on plug.dj.</li><li>Click on the channel or song name to open them in a new tab.</li></ul></div><button class='wt-p0-back'>Zurück</button><button class='wt-p0-next continue'>Weiter</button></div><div class='step fade-in wt-p0-info-footer' data-screen=info-footer><h1>Info Footer</h1><p>One last thing, plug_p0ne replaces the footer (the section below the chat) with something more useful.<br>To get to the Settings, the Shop or your Inventory, simply click anywhere on the footer.</p><p>The Info Footer only will work for logged in users, though.</p><button class='wt-p0-back'>Zurück</button><button class='wt-p0-next continue'>Weiter</button></div><div class='step fade-in wt-p0-info-flags' data-screen=info-flags><h1>" + flag('en') + " User Flags " + flag('pt') + "</h1><p>plug_p0ne checks a the language setting of other users, to show flags beside their names.These flags do <b>not</b> show their nationality, they show their <b>language setting</b>.There are three notable quirks here:<br><ul><li>plug_p0ne shows the UK flag for \"English\"</li><li>plug_p0ne shows the Brazil flag for \"Portugese\"</li><li>for technical reasons, the language setting of new users can't be read,unless they changed their language in the settings at least once.plug_p0ne shows these users without a flag.</li></ul></p><button class='wt-p0-back'>Zurück</button><button class='wt-p0-next continue'>Weiter</button></div><div class='step fade-in wt-p0-end' data-screen=end><h1>Ende!</h1><p>Alright that's it!<br>Hopefully you'll have some fun with plug_p0ne!</p><p>Just play around with the settings to find some more great features. :3</p><button class='wt-p0-back'>Zurück</button><button class='wt-p0-next continue'>Fertig</button></div><div class=nav><i class=selected></i> <i></i> <i></i> <i></i> <i></i> <i></i> <i></i> <i></i> <i></i> <i></i><button class='wt-p0-skip'>Tutorial Überspringen</button</div></div>").on('click', '.wt-p0-button', function(){
	      var $this;
	      $this = $(this);
